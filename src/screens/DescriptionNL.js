...
const DescriptionNL = (props,route) => {
...
const SRH = {
    ...
    >
      ...
      <View style={styles.background}>
        ...
        alignItems:'center',    
        marginTop:'10%', }}  onPress={()=>{props.navigation.navigate('RegisterWithoutLogin')
        } }>
        ...
        paddingRight:50,
        height: 40,
        borderWidth:1,}} >Register Without Logging In</Text>
            </TouchableOpacity>
