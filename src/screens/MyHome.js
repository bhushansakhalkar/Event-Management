...
const Home = (props,{navigation}) => {
  ...
  <Text style={styles.text}>Because You Liked Dance Events</Text>
  <View style={styles.container}> 
    ...
    <FlatList horizontal={true}
        ...
        keyExtractor={Because => Because.id}
      />
  
  </View><Text style={styles.text}>Trending</Text>
  <View style={styles.container}> 
  ...
  </View><Text style={styles.text}>Free Events</Text>
  <View style={styles.container}> 
